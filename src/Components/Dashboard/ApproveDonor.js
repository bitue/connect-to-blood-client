                    ...
                    <tbody>
                        {donorRequest.map((donorRq, index) => (
                            <tr className="border-[#222]">
                                ...
                                {
                                    donorRq?.user?.role === "donor" || donorRq?.user?.role === 'admin' ? <>
                                        <td>
                                            <button

                                                className="btn no-animation gap-2 bg-green-500 mr-[14px] hover:bg-green-500 border-green-500 text-white opacity-[0.3]"
                                            >
                                                Approve
                                            </button>
                                        </td>
                                        <td>
                                            <button
                                                ...
                                                className="btn no-animation gap-2 bg-primary hover:bg-primary border-primary hover:border-none   text-white opacity-[0.3] "
                                            >
                                                Deny
                                            </button>
                                        </td>
