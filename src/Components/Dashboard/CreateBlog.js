...
const CreateBlog = () => {
    ...
    const onSubmit = (data) => {
        data.user = user._id;
        axios
            .post('https://pear-gifted-lamb.cyclic.app/createBlog', data, {
                headers: {
    ...
    return (
        <div className="h-[550px] w-[450px] phone-2 text-center rounded-xl bg-[#fff] mx-auto mt-[30px] shadow-xl pt-[20px]">
            <h2 className="text-2xl mt-[20px] font-bold">
                Create <span className="text-[#ED4245]">Blog</span>
            </h2>
            <form
                action=""
            ...
            >
                <div className="form-control w-full max-w-xs">
                    ...
                    <input
                        ...
                        className="input input-bordered w-full max-w-xs border-[#222]"
                    ...
                    <textarea
                        placeholder="Bio"
                        className="textarea textarea-bordered textarea-md w-full max-w-xs border-[#222] "
